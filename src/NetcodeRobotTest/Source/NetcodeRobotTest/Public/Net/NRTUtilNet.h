 ...
 */
class FNetworkNotifyRobotHook : public FNetworkNotify
{
public:
    /**
     * Base constructor
     ...
     */
    FNetworkNotifyRobotHook(FNetworkNotify* InHookNotify)
        : FNetworkNotify()
     ...
     * Virtual destructor
     */
    virtual ~FNetworkNotifyRobotHook()
    {
    }
...
private:
    ...
    {
        //GActiveRobotLogWorld = AttachedWorld;
    }

    void PostTickFlush()
    {
        //GActiveRobotLogWorld = NULL;
	}
